...
set e=%cd%
set swf=AvalonUgh.LabsFlashActivity.ApplicationSprite.swf
set apk=air.com.abstractatech.gamification.augh.apk
set xml=air.com.abstractatech.gamification.augh.xml
